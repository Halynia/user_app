...
import 'package:user_app/mainScreens/select_nearest_active_driver_screen.dart';
    ...
    if(onlineNearByAvailableDriversList.length == 0)
      {
        ...
        Fluttertoast.showToast(msg: "Search Again after some time, Restarting app now.");
      ...
      if (map != null) {
        ...
        //whenever any driver become active/online
          ...
          case Geofire.onKeyExited:
            ...
            //whenever drive moves - update driver location
